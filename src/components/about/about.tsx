...
export default function about() {
	return (
		<Conteiner id='about'>
			...
			<div className='info'>
				<p>
					Localizada na R. Dr. Silvestre Ferraz, 546-Pinheirinho, Itajubá-MG. Nossa academia é um espaço exclusivo
					dedicado à musculação. Nos orgulhamos de oferecer uma
					...
					geral. Oferecemos planos flexíveis, incluindo opções mensais, trimestrais e anual, para atender às suas
			...
			<div className='img'>
				...
				<img src={img} alt="foto donos da academia" />
			</div>
		</Conteiner>
	)
}
